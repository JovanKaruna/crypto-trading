      ...
      <div className="lg:max-w-sm dark:text-white rounded-3xl overflow-hidden shadow-2xl">
        <div className="px-6 py-4">
          <div className="flex justify-between items-center mb-5">
            ...
            <select
              className="w-40 bg-white border border-grey text-black text-sm rounded-lg focus:ring-blue focus:border-blue block w-full p-2.5 dark:bg-grey-dark dark:border-grey dark:text-white"
              value={groupSize}
