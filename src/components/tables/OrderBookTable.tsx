    ...
    <div className="grid grid-cols-3 w-full gap-2">
      ...
      {sortPrices(asks, false)
        ...
        .map((ask, index) => (
          <div className="col-span-3 grid grid-cols-3 w-full" key={index}>
            <div className="text-red-error flex justify-center">{ask[0]}</div>
            <div className="flex justify-center">{ask[1]}</div>
            <div className="flex justify-center">{ask[2]}</div>
          </div>
        ))}
      ...
      {sortPrices(bids, true).map((bid, index) => (
        <div className="col-span-3 grid grid-cols-3 w-full gap-2" key={index}>
          <div className="text-green flex justify-center">{bid[0]}</div>
          <div className="flex justify-center">{bid[1]}</div>
          <div className="flex justify-center">{bid[2]}</div>
        </div>
      ))}
    </div>
  )
